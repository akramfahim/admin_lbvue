...
<div class="wrapper" id="app">
      ...
      <div class="user-panel mt-3 pb-3 mb-3 d-flex">
        ...
        <div class="info">
          <h3>
            ...
            <small class="text-info">{{ Auth::user()->type}}</small>
          </h3>
        </div>
      </div>
  ...
  <footer class="main-footer">
    ...
    <!-- Default to the left -->
    <strong>Copyright &copy; <a href="https://facebook.com/akramfahim.syl">Akram Fahim</a>.</strong> All rights reserved.
  </footer>
</div>
<!-- ./wrapper -->
